...
public class BattleshipGame {
    ...
    public void setUpGame() {
        ...
        System.out.println(" goal is to sink three Battleships");
        System.out.println("Angel, Tony, and Ivan");
        System.out.println(" sink all the ships with the fewest guesses.");
